...
public class Frame {
     ...
     * Data frame
     */
    public static final int DATA_FRAME = 31;

    /**
     * ACK frame
     */
    public static final int ACK_FRAME = 32;

    /**
     * NAK frame - NOT USED!
     */
    public static final int NAK_FRAME = 33;
     ...
     */
    public static Frame new_Data_Frame(int seq, int ack, int[] ackvector,
            String info) {
        Frame frame = new Frame();
        frame.set_DATA_frame(seq, ack, info);
        frame.set_ACK_vector(ackvector);
        return frame;
    }
    ...
    /**
     * Acknowledge number - for DATA and ACK packets; it defines the sequence
     * number of the last DATA frame successfully received for DATA and ACK
     */
    private int ack;
