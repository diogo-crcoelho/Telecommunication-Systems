 ...
 * channel. Implements methods to create new objects, to serialize and
 * deserialize.
 *
...
public class Event {
     ...
     */
    public static final int FRAME_EVENT = 6;
     ...
     */
    public static final int STAT_RETRANSMITED = 101;

    /**
     * Network payload transmitted statistics key value
     */
    public static final int STAT_PAYLOADS_TX = 102;

    /**
     * Network payload received statistics key value
     */
    public static final int STAT_PAYLOADS_RX = 103;

    /**
     * Invalid network payload received statistics key value
     */
    public static final int STAT_PAYLOADS_RX_INVALID = 104;

    /**
     * Network payload received with buffer full statistics key value
     */
    public static final int STAT_PAYLOADS_RX_BUFFERFULL = 105;
    ...
    /**
     * Auxiliary static function to parse an integer from a string and handles
     * null strings
     *
    ...
    /**
     * Auxiliary static function to parse a long from a string and handles null
     * strings
     *
     * @param str the string with the number
