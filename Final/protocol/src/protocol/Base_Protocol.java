...
/**
 * Base protocol class that defines support functions for a basic timer
 * interface, manipulating sequence numbers and default event handlers
 *
...
public class Base_Protocol implements Callbacks {
     ...
     * @param n sequence number
     * @param k increment
     * @return the addition of the sequence number
     */
